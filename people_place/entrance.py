...
from people_place.centroidtracker import CentroidTracker
from people_place.trackableobject import TrackableObject
...
# default value is 6, will ring alarm after 'count' number of people are inside facility
ap.add_argument("-d","--count1", type=int, default=6, help="minimum count of the people to allow inside the facility")
...
while True:
    ...
    for (objectID, centroid) in objects.items():
        ...
        # to determine direction
            ...
            #calculate number of people inside the facility
            sum1 = totalDown-totalUp

            # check if number of people inside the facility exceeds limit
            if sum1>= 3:
                # if yes, play the alarm   
                
                winsound.PlaySound(r"C:\Users\dindu\Desktop\project\alarm.wav", winsound.SND_ASYNC | winsound.SND_ALIAS )        
            print("alarm blowing")
