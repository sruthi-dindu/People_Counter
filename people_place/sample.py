...
ap.add_argument("-d","--count1",type=int,default=3,help="minimum count of the people to allow inside the store")
        ...
        # to determine direction
            ...
            if centroid[0] > 0 and centroid[0] <W and centroid[1] >0 and centroid[1] <H:
                ...
                if inFrame > args ["count1"]:
                    playsound("Resources/alarm2.mp3")
            ...
            if not to.counted:
                ...
                # center line, count the object
                    ...
                    sum = totalDown-totalUp

                    if sum>=4:
                        playsound("Resources/alarm.mp3")
                        #p = multiprocessing.Process(target=playsound, args=("Resources/alarm.mp3",))
                        #p.start()
